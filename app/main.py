...
from .api import users_router, employee_router, country_router, common_router, role_router, visa_router, vendor_router, coupon_router  # Import country routes 
...
app.include_router(visa_router) #Add visa router
app.include_router(vendor_router) #Add vendor router
app.include_router(coupon_router) #Add coupon router
